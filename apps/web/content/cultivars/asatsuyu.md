...
kanji: 朝露
romaji: Asatsuyu
nameMeaning: "Literally 'morning dew.' The 1953 registration bulletin's own naming rationale (命名の由来), however, is narrower than the poetic gloss suggests: it reads 葉色が濃緑で天然玉露の別名がある — 'the leaf colour is deep green, hence the alternative name natural gyokuro (天然玉露).' That is, the primary source explains the natural gyokuro nickname, tying it to leaf colour, but does not itself spell out why the registered name Asatsuyu was chosen; the bulletin's cultivar headings are written in kana throughout and do not gloss the kanji 朝露."
registered: 1953
registrationNumber: 茶農林2号 (Cha Norin No. 2)
...
notableDescendants:
  - Saemidori (pollen parent — Yabukita ♀ × Asatsuyu ♂, crossed 1969; registered both as Cha Norin No. 40, 1990, and under the Plant Variety Protection Act, No. 2881, 1991)
  - Tsuyuhikari (pollen parent — Shizu7132 ♀ × Asatsuyu ♂, crossed 1970 at the Shizuoka Tea Experiment Station; Shizu7132 is itself an open-pollinated Yabukita seedling. Adopted as a Shizuoka Prefecture recommended cultivar in 2001 and registered under the Plant Variety Protection Act in 2003)
...
sources:
  ...
  - title: 附表1 茶農林登録品種一覧 (List of Cha Norin Registered Tea Cultivars)
  ...
  - title: Aoki, "Growth and Quality of a Spontaneous Mutant Derived from Cultivar Asatsuyu," 茶業研究報告 59, 1984
    url: https://www.jstage.jst.go.jp/article/cha1953/1984/59/1984_59_1/_article/-char/en
  - title: Furuno, "Varietal Differences of Resistance to Tea Gray Blight," 茶業研究報告 83, 1996
    url: https://www.jstage.jst.go.jp/article/cha1953/1996/83/1996_83_41/_article/-char/en
  - title: 心向樹 (Shinkoju) — あさつゆ
    url: https://www.shinkoju.com/%E5%93%81%E7%A8%AE%E8%8C%B6/%E3%81%82%E3%81%95%E3%81%A4%E3%82%86/
  - title: 日本茶備忘録 (japantea-chachacha.com) — あさつゆ
...
Asatsuyu is a sencha cultivar selected from Uji zairai seedlings and registered in 1953 as Cha Norin No. 2 — the second cultivar named in Japan's first round of tea variety registrations, immediately after Benihomare. It exists to answer a specific question: how close a seed-grown Uji-type tea can come, unshaded, to the flavour of a shaded gyokuro. Growers and researchers have called it 天然玉露, "natural gyokuro," since that first registration bulletin, for a leaf colour and cup character that suggested shading effects the plant was producing on its own. Its long-term significance turned out to lie less in its own cultivation, which stayed marginal, than in its role as a parent: it is the pollen parent of both Saemidori and Tsuyuhikari, and the seed parent of Yutakamidori.

## Lineage

- **Uji zairai seed stand, Kyoto** — an individual seedling selection from seed-grown Uji-type stock, not a controlled cross; no specific mother plant or pollen source is recorded.
...
The seedling that became Asatsuyu was grown from Uji-type seed sown at the Ministry of Agriculture and Commerce's Agricultural Experiment Station, Tea Manufacturing Division, in Nishigahara, Tokyo. It was transplanted in 1921 (Taisho 10) to the ministry's tea experiment station, by then relocated to Kanaya in Shizuoka — the institution's line of succession runs through to today's NARO Institute of Fruit Tree and Tea Science. Development was completed there in 1944 (Showa 19), under the working designation Kokucha U14 (国茶U14号).

It was registered in October 1953 as Cha Norin No. 2, one of fifteen cultivars named in Japan's first round of tea variety registrations — ten for green tea (eight sencha, one tamaryokucha, one kamairicha) and five for black tea. The registration bulletin, 茶の品種登録と命名 (茶業研究報告 No. 2), gives its suitable range as northern Kyushu, the Chugoku region, and the prefectures near Shizuoka, and summarises it as a strong-growing, upright cultivar with long-elliptic, deep-green leaves, "excellent as a green tea, particularly as ordinary sencha, and known by the alternative name natural gyokuro." The bulletin's own naming rationale for that alternative name is short and specific: dark leaf colour, not chemistry.

### A parent more consequential than a cultivar

Asatsuyu's own footprint stayed small, but the two crosses made from it in 1969 and 1970 turned out to matter far more. Saemidori, crossed at Makurazaki in Kagoshima with Yabukita as the seed parent and Asatsuyu as the pollen parent, was registered under Cha Norin No. 40 in 1990 and separately under the Plant Variety Protection Act (No. 2881) in 1991 — it went on to become one of the most widely planted specialty cultivars in Japan and a parent in its own right several times over. Tsuyuhikari, crossed the following year at the Shizuoka Tea Experiment Station from Shizu7132 (a Yabukita seedling) and Asatsuyu, was selected by individual selection in 1979, trialled for local adaptability from 1991 to 1997, adopted as a Shizuoka Prefecture recommended cultivar in 2001, and registered under the Plant Variety Protection Act in 2003; the release paper credits it with high yield, cold hardiness better than Yabukita's, and fair resistance to tea anthracnose. Yutakamidori, grown from open-pollinated Asatsuyu seed at the national tea experiment station, never received the same formal registration but is documented in NARO's pedigree charts as a parent of later cultivars including Kanaemaru (2022).
...
None of this made Asatsuyu a commercial success on its own terms. It is grown today mostly in warm, frost-light districts — Kagoshima is the region most often cited, though this research could not independently source a cultivation-area or regional-share figure to put a number on it. What did succeed, decisively, is its genetics: crossed twice in 1969 and 1970 while its own plantings were struggling with survival and frost, it became the pollen parent behind Saemidori and Tsuyuhikari, and through Saemidori's own many offspring, one of the two cultivars — with Yabukita — that most of Japan's post-war specialty sencha traces back to.
