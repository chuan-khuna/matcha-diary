...
Ujimidori is one of the late additions to the Uji cultivar group — selected by the Kyoto
Prefectural Tea Research Institute in 1983, three decades after the 1954 batch that produced
...
- **Uji zairai** ♀ — a landrace seedling. As with every zairai selection in this collection, the
  pollen parent was never recorded and could not have been.

That puts it in the same category as Samidori and Asahi, and distinguishes it sharply from the
Institute's other modern work: Houshun and Tenmyo, registered in 2006, are open-pollinated
seedlings *of* Samidori, one generation further from the landrace. Ujimidori goes back to the
zairai stand directly.

## History

The Institute recorded it as developed in 1983 under the designation Kyoken No. 307 — the same
numbering series that produced Kyoken 283, also in this collection. Neither was carried through to
formal registration.

The one piece of applied research that surfaces for it is a blending trial: Ujimidori blended with
Yabukita at a 60:40 ratio is reported to have given the best results two years running, in 2009
and 2010. That is a fair indication of how it is actually used — as a quality component in a blend
rather than as a single-cultivar tea — and of why it has stayed rare. A cultivar valued for what
it contributes to a blend does not need a large planted area to matter.
